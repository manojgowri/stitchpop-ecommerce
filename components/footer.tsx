      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Stitch POP</h3>
            ...
            <div className="flex space-x-4">
              <Link href="https://www.instagram.com/stitchpopclothing/" target="_blank" rel="noopener noreferrer">
                <Instagram className="h-5 w-5 hover:text-orange-400 transition-colors" />
              </Link>
              <Link href="#" target="_blank" rel="noopener noreferrer">
                <Facebook className="h-5 w-5 hover:text-orange-400 transition-colors" />
              </Link>
              <Link href="#" target="_blank" rel="noopener noreferrer">
                <Twitter className="h-5 w-5 hover:text-orange-400 transition-colors" />
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <a
                  href="mailto:stitchpopclothing@gmail.com"
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+919600958937" className="text-gray-300 hover:text-white transition-colors">
                  +91 9600958937
                </a>
              </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">© 2024 Stitch POP. All rights reserved.</p>
