                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@stitchpop.in</p>
                      <p className="text-gray-600">orders@stitchpop.in</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        We typically ship within 1-2 business days, and delivery takes 3-7 business days depending on
                        your location.
                      </p>
                    </div>
                    <div>
