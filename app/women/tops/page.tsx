...
export default function WomenTopsPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      // Join with categories to filter by tops
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Stylish tops and blouses for every occasion</p>
      </div>
      ...
      {products.length > 0 ? (
            ...
            <Link key={product.id} href={`/product/${product.id}`}>
              <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                <div className="aspect-square relative">
                  <img
                    src={product.images[0] || "/placeholder.svg?height=300&width=300&text=Top"}
                    alt={product.name}
        ...
        <div className="text-center py-12">
          <p className="text-muted-foreground">No tops available at the moment.</p>
          <Link href="/women">
